...
the header and footer. It declares with `ngApp` that this is `SimpleLandingPage`,
...
"SimpleLandingPage" will rename the resultant CSS and JavaScript placed in `build/`,
